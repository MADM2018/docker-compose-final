...
<head>
    ...
    <title><?php if ($active != "index") {
        echo $title . " | NotiFresh.com";
    } else {
        echo $title;
    } ?></title>
    ...
    <?php if (!isset($link)) { ?>
    <meta name="author" content="NotiFresh.com" />
    <meta property="og:site_name" content="NotiFresh.com" />
    <meta property="og:url" content="<?php echo $og_url; ?>" />
    <?php } ?>

    <?php if (!isset($article)) { ?>
    <meta name="description" content="El mejor contenido que se comparte en la web. Noticias virales. Ultima hora." />
    <?php } else { ?>
    ...
    <script>
        ...
        window.cookieconsent.initialise({
            ...
            "position": "top",
            "content": {
            "message": "Este sito web usa cookies para facilitar tu navegación. Los datos personales no son consultados. Si continúas navegando consideramos que aceptas su uso.",
            "dismiss": "Acepto!",
            "link": "Leer mas",
            "href": "https://www.notifresh.com/privacity"
            }
        })});
    </script>

	<meta name="keywords" content="noticias,ciencia,tecnologia,naturaleza,entretenimiento,insolito,curiosidades,lo mejor,impactante,inspiracion,salud,sorprendente" />
	...
	<?php if ($active == 'index') { ?>
	    <link rel="stylesheet" href="<?php echo assets_url('css/flexslider.css'); ?>" type="text/css" />
	<?php } ?>

    <script src="<?php echo assets_url('js/jquery-1.11.1.min.js'); ?>"></script>

	<script src="<?php echo assets_url('js/jquery.dotdotdot.min.js'); ?>" type="text/javascript"></script>

    <?php if ($this->logged_in === true) { ?>
        <link href="<?php echo assets_url('css/sweetalert.css'); ?>" rel='stylesheet' type='text/css' />
